        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Box sx={{ display: "flex" }}>{iconsCardDepartures[0]}</Box>
              ...
              >
                <Box sx={{ display: "flex" }}>{iconsCardDepartures[1]}</Box>
                <Typography sx={{ fontSize: { xs: ".6rem", sm: ".8rem", md: "1rem" } }}>
              ...
              >
                <Box sx={{ display: "flex" }}>{iconsCardDepartures[2]}</Box>
                <Typography sx={{ fontSize: { xs: ".6rem", sm: ".8rem", md: "1rem" } }}>
              ...
              >
                <Box sx={{ display: "flex" }}>{iconsCardDepartures[3]}</Box>
                <Typography sx={{ fontSize: { xs: ".6rem", sm: ".8rem", md: "1rem" } }}>
