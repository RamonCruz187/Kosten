        ...
        const response = await axios.post(
            ...
            formData,
            {
                headers: {
                    ...
                    // Authorization: `Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyM0BnbWFpbC5jb20iLCJpYXQiOjE3MzAxODYxNjksImV4cCI6MTczMDI3MjU2OX0.WkMpN2gJrokFb3aHDAIZY18Q9JI0dZvWVyYIqkg5HD8`//`Bearer ${token}` // Add your Bearer token if necessary
...
/>
      ...
      <DialogActions>
        <Button onClick={onClose} color='transparent'>Cancelar</Button>
        <Button onClick={handleSubmitAdd} variant="contained" color='transparent'>Guardar</Button>
      </DialogActions>
    </Dialog>
  );
};
...
//       formData.append('name', staffForm.name);
//       formData.append('lastName', staffForm.lastName);
//       formData.append('rol', 'STAFF'); // Assuming 'STAFF' role is constant
//       formData.append('contact', staffForm.contact);
//       formData.append('photo', file);

//       await axios.put('https://kostentours-api-10061c08f8f8.herokuapp.com/staff/new', formData, {
//         headers: {
//           'Authorization': `Bearer YOUR_TOKEN_HERE`,  // Replace YOUR_TOKEN_HERE with actual token logic
//           'Content-Type': 'multipart/form-data',
//         },
//       });
//       NotificationService.success('Staff member created successfully', 2000);
...
//     <Dialog open={open} onClose={onClose}>
//       <DialogTitle align="center">
//         <Typography variant="h6">NUEVO STAFF</Typography>
//       </DialogTitle>
//       <DialogContent>
//         <TextField
//           label="Nombre"
...
//***************version 1 ***** */
// // src/components/Dashboard/AddStaffDialog.jsx
// import React, { useState } from 'react';
// import {
//   Dialog,
//   DialogActions,
