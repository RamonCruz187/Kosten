// src/components/Dashboard/AddUserDialog.jsx
...
const AddUserDialog = ({ open, onClose, fetchUsers }) => {
  ...
  const handleSubmitAdd = async () => {
    if (!validatePassword(userForm.password)) {
      NotificationService.info("La contraseña debe tener entre 6-12 caracteres, al menos 1 mayúscula, 1 número y 1 carácter especial.", 5000);
      return;
    }
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      <DialogTitle align='center'><Typography variant="h6" align="center">NUEVO USUARIO</Typography></DialogTitle>
      <DialogContent>
        <TextField
          label="Nombre"
          name="username"
      ...
      <DialogActions>
        ...
        <Button onClick={handleSubmitAdd} color="primary">Guardar</Button>
      </DialogActions>
    </Dialog>
  );
};
